...
PROTOBUF_NAMESPACE_OPEN
template <>
::myrpc::RpcHeader* Arena::CreateMaybeMessage<::myrpc::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace myrpc {

// ===================================================================

class RpcHeader final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:myrpc.RpcHeader) */ {
  public:
  ...
  protected:
    explicit RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
  ...
  public:
    ...
    void clear_methond_name();
    const std::string& methond_name() const;
    template <typename ArgT0 = const std::string&, typename... ArgT>
    void set_methond_name(ArgT0&& arg0, ArgT... args);
    std::string* mutable_methond_name();
    PROTOBUF_NODISCARD std::string* release_methond_name();
    void set_allocated_methond_name(std::string* methond_name);

  private:
    const std::string& _internal_methond_name() const;
    inline PROTOBUF_ALWAYS_INLINE void _internal_set_methond_name(const std::string& value);
    std::string* _internal_mutable_methond_name();
  ...
  private:
    ...
    struct Impl_ {
        ...
        ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr methond_name_;
        uint32_t args_size_;
...
// bytes methond_name = 2;
inline void RpcHeader::clear_methond_name() {
    _impl_.methond_name_.ClearToEmpty();
}
inline const std::string& RpcHeader::methond_name() const {
    // @@protoc_insertion_point(field_get:myrpc.RpcHeader.methond_name)
    return _internal_methond_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void RpcHeader::set_methond_name(ArgT0&& arg0, ArgT... args) {

    _impl_.methond_name_.SetBytes(static_cast<ArgT0&&>(arg0), args..., GetArenaForAllocation());
    // @@protoc_insertion_point(field_set:myrpc.RpcHeader.methond_name)
}
inline std::string* RpcHeader::mutable_methond_name() {
    std::string* _s = _internal_mutable_methond_name();
    // @@protoc_insertion_point(field_mutable:myrpc.RpcHeader.methond_name)
    return _s;
}
inline const std::string& RpcHeader::_internal_methond_name() const {
    return _impl_.methond_name_.Get();
}
inline void RpcHeader::_internal_set_methond_name(const std::string& value) {

    _impl_.methond_name_.Set(value, GetArenaForAllocation());
}
inline std::string* RpcHeader::_internal_mutable_methond_name() {

    return _impl_.methond_name_.Mutable(GetArenaForAllocation());
}
inline std::string* RpcHeader::release_methond_name() {
    // @@protoc_insertion_point(field_release:myrpc.RpcHeader.methond_name)
    return _impl_.methond_name_.Release();
}
inline void RpcHeader::set_allocated_methond_name(std::string* methond_name) {
    if (methond_name != nullptr) {

    } else {
    }
    _impl_.methond_name_.SetAllocated(methond_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    if (_impl_.methond_name_.IsDefault()) {
        _impl_.methond_name_.Set("", GetArenaForAllocation());
    }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
       // @@protoc_insertion_point(field_set_allocated:myrpc.RpcHeader.methond_name)
}
